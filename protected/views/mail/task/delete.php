...
echo "Aww. " . PHtml::encode($user->fullName) . " deleted " . PHtml::encode($data->name) . " from " . PHtml::link(PHtml::encode("Poncla"), Yii::app()->request->hostInfo . Yii::app()->createUrl('site/index')) . " .";
